...
$cmd = "/stornext/snfs0/next-gen/yw14-scratch/samtools-0.1.7a/samtools pileup -vcf /stornext/snfs0/next-gen/hg19/GRCh37-lite.fa ".$sample.".sorted.dups.removed.bam  >& ".$sample.".sorted.dups.removed.raw.pileup";
...
#$cmd = "/users/p-merge/merg_cap_scripts/annotate_Ardmore.pl -c 0,1,2,2,3 -d 130 -i $SNP_file";
#print STDERR "$cmd\n\n";
#system("$cmd");

#$cmd = "/users/p-merge/merg_cap_scripts/miRNAnnotate.pl -c 0,1,2,2,3 -i $SNP_file";
#print STDERR "$cmd\n\n";
#system("$cmd");
